            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin.subsidyType.record') }}">Subsidy Type</a>
                        <a class="collapse-item" href="{{ route('admin.subsidy.record') }}">Subsidies</a>
                    </div>
                </div>
            </li>
